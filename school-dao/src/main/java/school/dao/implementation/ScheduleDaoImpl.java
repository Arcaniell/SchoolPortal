...
public class ScheduleDaoImpl extends BaseDaoImpl<Schedule, Long> implements ScheduleDao {
	...
	public List<Schedule> findByGroup(Group group) {
		try{
			return (List<Schedule>) entityManager.createNamedQuery(Schedule.FIND_BY_GROUP)
	...
	public List<Schedule> findByRoom(Room room) {
		try{
			return (List<Schedule>) entityManager.createNamedQuery(Schedule.FIND_BY_ROOM)
	...
	public List<Schedule> findByTeacher(Teacher teacher) {
		try{
			return (List<Schedule>) entityManager.createNamedQuery(Schedule.FIND_BY_TEACHER)
	...
	public List<Schedule> findByDates(Date from, Date till) {
		try{
			return (List<Schedule>) entityManager.createNamedQuery(Schedule.FIND_BY_DATES)
	...
	public List<Schedule> findByTeacherInterval(long teacherId, Date from,
			Date till) {
		try{
			return (List<Schedule>) entityManager.createNamedQuery(Schedule.FIND_BY_TEACHER_INTERVAL)
	...
	public List<Schedule> findByGroupInterval(long groupId, Date from, Date till) {
		try{
			return (List<Schedule>) entityManager.createNamedQuery(Schedule.FIND_BY_GROUP_INTERVAL)
	...
	public List<Schedule> findByRoomInterval(int roomId, Date from, Date till) {
		try{
			return (List<Schedule>) entityManager.createNamedQuery(Schedule.FIND_BY_ROOM_INTERVAL)
